...
string Aes::generateKey()
{
    ...
    SecByteBlock keyBytes(AES::DEFAULT_KEYLENGTH);
...
string Aes::encrypt(string key, string plainText, byte iv[])
{
    ...
    CBC_Mode<AES>::Encryption desEncryptor;
...
string Aes::decrypt(string key, string cipherText, byte iv[])
{
    ...
    CBC_Mode<AES>::Decryption desDecryptor;
